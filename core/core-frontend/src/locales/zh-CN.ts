export default {
  ...
  chart: {
    align: '对齐方式',
    reset: '重置',
    chart_refresh_tips: '图表刷新设置优先于数据看板刷新设置',
    '1-trend': '趋势',
    '2-state': '状态',
    '3-rank': '排名',
    '4-location': '位置',
  ...
  dataset: {
    ...
    tips: '提示',
    confirm_delete: '确认删除',
    confirm_delete_msg: '数据集删除，会影响与其相关的自定义数据集、关联数据集、数据看板，确认删除？',
    delete_success: '删除成功',
    confirm: '确认',
    cancel: '取消',
    search: '搜索',
    ...
    task: {
      ...
      excel_replace_msg: '可能会影响自定义数据集、关联数据集、数据看板等，确认替换？',
  ...
  deDataset: {
    ...
    create_dashboard: '创建数据看板',
    cannot_be_empty: 'SQL不能为空',
    data_reference: '数据参考',
    want_to_replace: '替换可能会影响自定义数据集、关联数据集、数据看板等，是否替换？',
  ...
  commons: {
    ...
    thumbnail: '缩略图',
    confirm_delete: '确认删除',
    delete_this_dashboard: '确认删除该数据看板吗?',
  ...
  visualization: {
    ...
    unpublished_tips: '取消发布后，该数据看板不能被查看。确定要取消发布？',
    ...
    watermark: '水印',
    panel_get_data_error: '获取数据看板信息失败，数据看板可能已经被删除，请检查数据看板状态',
    panel_no_save_tips: '存在未保存的数据看板',
    panel_cache_use_tips: '检查到上次有数据看板未能正常保存，是否使用上次未保存的数据看板？',
    template_name_tips: '数据看板名称必填',
    panel_background_item: '自定义数据看板背景',
    ...
    link_expire: '链接已过期！',
    link_share: '链接分享',
    link_share_desc: '开启链接后，任何人可通过此链接访问数据看板。',
    share: '分享',
    remove_share_confirm: '确认取消当前数据看板所有分享？',
    share_in: '分享给我',
    share_out: '我的分享',
    who_share: '分享人',
    when_share: '分享时间',
    ...
    select_panel_from_left: '请从左侧选择数据看板',
    template_nale: '模板名称',
    template: '模板',
    category: '分类',
    all_org: '所有组织',
    ...
    redo: '重做',
    undo: '撤销',
    panelNull: '这是个空的数据看板，可以通过编辑来丰富内容',
    copy: '复制',
    paste: '粘贴',
    cut: '剪切',
    lock: '锁定',
    ...
    other_module: '其他',
    content: '内容',
    default_panel_name: '默认数据看板名称',
    source_panel_name: '原数据看板名称',
    content_style: '内容样式',
    canvas_self_adaption: '自适应画布区域',
    panel_save_tips: '数据看板已变动，是否保存？',
    panel_save_warn_tips: '如果未保存，你对数据看板做的变更将会丢失！',
    do_not_save: '不保存',
    save: '保存',
    drill: '下钻',
    linkage: '联动',
    ...
    aided_grid_close: '关闭',
    export_pdf_page: '分页线',
    export_pdf_page_remark: '仅对API导出数据看板PDF分页有效',
    ...
    public_link_tips: '当前是公共链接模式，目标数据看板未设置公共链接，无法跳转',
    input_title: '请输入标题',
    show_title: '标题',
    ...
    pdf_template_with_params: '默认模板(加数据看板描述)',
  ...
  watermark: {
    ...
    enable: '启用水印',
    enable_panel_custom: '允许数据看板单独打开或者关闭水印',
    content: '水印内容',
  ...
  roleKey : {
    ...
    'template-market': '模版中心',
    template_select: '查看模版',
    template_preview: '预览模版',
    template_use: '应用模版',
    user_select: '查看用户',
    user_add: '添加用户',
    user_update: '更新用户',
